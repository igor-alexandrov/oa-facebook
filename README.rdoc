...
or if you want use custom text then use:

  <%= facebook_login_button("Login with Facebook") %>

or if you want set custom permissions then use (default is set to "email"):

  <%= facebook_login_button("Login with Facebook", "email, user_groups, user_events") %>
